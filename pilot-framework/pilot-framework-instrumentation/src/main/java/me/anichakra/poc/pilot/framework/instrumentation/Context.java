...
/**
 * This is an enumeration of all the elements in the context of an invocation
 * event.
 * 
 * @author anichakra
 *
...
public enum Context {
	...
	/**
	 * The target application or code to which this request is made. Event
	 * generation starts from target.
	 */
	TARGET,
	...
	/**
	 * The conversation id that is generated when an event is starting. This
	 * conversation id is passed to another application or system and there it
